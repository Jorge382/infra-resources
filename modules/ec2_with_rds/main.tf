...
resource "aws_key_pair" "key" {
  key_name   = "key-jvs.pem"
  public_key = file("/home/jorge/.ssh/key-jvs.pem")  # Ruta de tu clave pública en tu máquina local
}
